; call this putting effect number into the accumulator
...
_resetsound
  	...
  	cmp #128
  	beq _play_it       ; SOUND NOT PLAYING
  	...
  	beq _playsounds    ; GO TO PLAY SOUNDS, try next voice
